...
var KTSignupGeneral=function(){
    ...
    return{
        init:function(){
            ...
            s=KTPasswordMeter.getInstance(e.querySelector('[data-kt-password-meter="false"]')),
                                                                            ...
                                                                            notEmpty:{
                                                                                ...
                                                                                identical:{
                                                                                    compare:function(){
                                                                                        ...
                                                                                        plugins:{trigger:new FormValidation.plugins.Trigger({event:{password:!1}}),
                                                                                        bootstrap:new FormValidation.plugins.Bootstrap5({rowSelector:".fv-row",eleInvalidClass:"",eleValidClass:""})}}),
                                                                                        t.addEventListener("click",(function(r){r.preventDefault(),a.revalidateField("password"),a.validate().then((function(a){"Valid"==a?(t.setAttribute("data-kt-indicator","on"),
                                                                                        t.disabled=!0,setTimeout((function(){t.removeAttribute("data-kt-indicator"),t.disabled=!1
                                                                                        // Swal.fire({
