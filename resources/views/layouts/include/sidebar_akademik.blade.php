<div class="menu-item">
    <a class="menu-link {{ Route::is('dosen.akademik.bimbingan.*') ? 'active' : '' }}"
        href="{{ route('dosen.akademik.bimbingan.index') }}">
...
<div class="menu-item">
    <a class="menu-link {{ Route::is('dosen.akademik.ujian.*') ? 'active' : '' }}"
        href="{{ route('dosen.akademik.ujian.index') }}">
        <span class="menu-icon">
            <span class="far fa-calendar-alt fs-2x">
...
{{-- <div class="menu-item">
    <a class="menu-link menu-link {{Route::is('ujian.index') ? 'active' : ''}}" href="{{ route('ujian.index') }}">
        <span class="menu-icon">
            <span class="svg-icon svg-icon-primary svg-icon-2x">
                <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo2/dist/../src/media/svg/icons/General/Notifications1.svg--><svg
