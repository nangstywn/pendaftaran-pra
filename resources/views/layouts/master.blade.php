        ...
        <div class="page d-flex flex-row flex-column-fluid">
            ...
            <div id="kt_aside" class="aside" data-kt-drawer="true" data-kt-drawer-name="aside"
                        ...
                        <div class="aside-user-info flex-row-fluid flex-wrap ms-5">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1 me-2">
                                    <!--begin::Username-->
                                    <a href="#"
                                        class="text-white text-hover-primary fs-6 fw-bold">{{ Auth::user()->nim ?? Auth::guard('dosen')->user()->nidn }}</a>
                                    <div class="d-flex align-items-center text-success fs-9">
                                        <span class="bullet bullet-dot bg-success me-1"></span>
                                        @if (Auth::guard('web')->check())
                                            {{ Jurusan::label(Auth::user()->jurusan) }}
                                        @else
                                            {{ Auth::guard('dosen')->user()->role ?? '-' }}
                                        @endif
                                    </div>
                                    <span
                                        class="text-gray-600 fw-bold d-block fs-8 mb-1">{{ Auth::user()->tahun_angkatan ?? '' }}</span>
                                </div>
                                <!--end::Info-->
                                <!--begin::User menu-->
                                <div class="me-n2">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px"
                                            ...
                                            <div class="menu-content d-flex align-items-center px-3">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <div class="fw-bolder d-flex align-items-center fs-5">
                                                        {{ Auth::user()->nama_mahasiswa ?? Auth::guard('dosen')->user()->nama_dosen }}
                                                        <span
                                        ...
                                        <div class="menu-item px-5">
                                            @if (Auth::guard('web')->check())
                                                <a href="{{ route('profile', Auth::user()->nim) }}"
                                                    class="menu-link px-5">My
                                                    Profile</a>
                                            @else
                                                <a href="{{ route('profile', Auth::guard('dosen')->user()->id) }}"
                                                    class="menu-link px-5">My
                                                    Profile</a>
                                            @endif
                                        </div>
                ...
                <div class="aside-menu flex-column-fluid">
                    <!--begin::Aside Menu-->
                    <div class="hover-scroll-overlay-y px-2 " id="kt_aside_menu_wrapper" data-kt-scroll="true"
                        ...
                        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                            ...
                            @if (Auth::guard('web')->check())
                                @include('layouts.include.sidebar_mhs')
                            @endif
                            @if (Auth::guard('dosen')->check())
                                @if (Auth::guard('dosen')->user()->role == 'dosen')
                                    @include('layouts.include.sidebar_pembimbing')
                                @elseif(Auth::guard('dosen')->user()->role == 'kaprodi' || Auth::guard('dosen')->user()->role == 'sekprodi')
                                    @include('layouts.include.sidebar_prodi')
                                @elseif(Auth::guard('dosen')->user()->role == 'akademik')
                                    @include('layouts.include.sidebar_akademik')
                                @endif
                            @endif
                        </div>
                        <!--end::Menu-->
