                    ...
                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                <a href="#"
                                    class="text-gray-900 text-hover-primary fs-2 fw-bolder me-1">{{ $user->nama_mahasiswa ?? $user->nama_dosen }}</a>
                                <a href="#">
                            ...
                            <div class="d-flex flex-wrap fw-bold fs-6 mb-4 pe-2">
                                <a href="#"
                                    ...
                                    <!--end::Svg Icon-->{{ $user->role ?? 'mahasiswa' }}
                                </a>
                                <!-- <a href="#"
                                            class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
                                            <span class="svg-icon svg-icon-4 me-1">
    ...
    <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
        ...
        <div class="card-header cursor-pointer">
            ...
            <a href="" data-bs-toggle="modal" data-bs-target="#password"
                class="btn btn-primary align-self-center">Change Password
            </a>
            <!--end::Action-->
        </div>
        <!--begin::Card header-->
        ...
        <div class="card-body p-9">
            ...
            <div class="row mb-7">
                ...
                <!--begin::Col-->
                <div class="col-lg-8">
                    <span class="fw-bolder fs-6 text-gray-800">{{ $user->nama_mahasiswa ?? $user->nama_dosen }}</span>
                </div>
                <!--end::Col-->
            </div>
            <!--end::Row-->
            ...
            <div class="row mb-7">
                @if (Auth::check())
                    ...
                    <div class="col-lg-8 fv-row">
                        <span class="fw-bolder text-gray-800 fs-6">{{ $user->nim }}</span>
                    </div>
                @else
                    <label class="col-lg-4 fw-bold text-muted">NIDN</label>
                    <div class="col-lg-8 fv-row">
                        <span class="fw-bolder text-gray-800 fs-6">{{ $user->nidn }}</span>
                    </div>
                @endif
            </div>
            <div class="row mb-7">
                @if (Auth::check())
                    ...
                    <div class="col-lg-8 fv-row">
                        <span class="fw-bolder text-gray-800 fs-6">{{ Jurusan::label($user->jurusan) }}</span>
                    </div>
                @else
                    <label class="col-lg-4 fw-bold text-muted">Role</label>
                    <div class="col-lg-8 fv-row">
                        <span class="fw-bolder text-gray-800 fs-6">{{ $user->role }}</span>
                    </div>
                @endif
            </div>
            <!--end::Input group-->
            ...
            <div class="row mb-7">
                ...
                <div class="col-lg-8 d-flex align-items-center">
                    <span class="fw-bolder fs-6 text-gray-800 me-2">{{ $user->no_tlpn ?? '-' }}</span>
                </div>
                <!--end::Col-->
            </div>
