    ...
    <div class="row">
        <div class="col">
            <div class="card">
                ...
                <form action="{{ route('mahasiswa.pendaftaran.update', $pendaftaran->id_pendaftaran) }}" method="POST"
                                        ...
                                        <div class="col-md-4 fv-row">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nim" id="nim"
                                                    ...
                                                    value="{{ $pendaftaran->nim }}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-4 fv-row">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="semester" id="semester" min="1"
                                                    class="form-control"
                                                    value="{{ old('semester') ?? $pendaftaran->semester }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="tahun_ajaran" id="tahun_ajaran" class="form-select"
                                                    ...
                                                    @foreach (TahunAjaran::labels() as $key => $value)
                                                        @if (!empty(old('tahun_ajaran')))
                                                            <option value="{{ $key }}"
                                                                {{ old('tahun_ajaran') == $key ? 'selected' : '' }}>
                                                                {{ $value }}</option>
                                                        @else
                                                            <option value="{{ $key }}"
                                                                {{ $pendaftaran->tahun_ajaran == $key ? 'selected' : '' }}>
                                                                {{ $value }}</option>
                                                        @endif
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-4 fv-row">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="tanggal" id="tanggal"
                                                    ...
                                                    value="{{ Carbon\Carbon::parse($pendaftaran->tanggal)->format('d M Y') }}"
                                        ...
                                        <div class="col-md-4 fv-row">
                                            <div class="form-group">
                                                ...
                                                <select name="dosen" id="dosen" class="form-select"
                                                    ...
                                                    @else
                                                        <option value="{{ $pendaftaran->id_dosen }}" selected>
                                                            {{ optional($pendaftaran->dosen)->nama_dosen }}</option>
                                                    @endif
                                                </select>
                                ...
                                <div class="d-flex flex-column mb-5 fv-row">
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <textarea name="judul" id="" class="form-control" placeholder="Masukkan Judul Skripsi...">{{ old('judul') ?? $pendaftaran->judul }}</textarea>
                                            @error('judul')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
